// RUN: mlir-translate --import-dxsa-bin %S/inputs/cbuffer2.50.bin | FileCheck %s
...
// CHECK:         %[[OPERAND_1:.*]] = dxsa.operand %[[INDEX_1]], %[[INDEX_2]] {num_components = 4 : i32, swizzle = dense<[3, 1, 1, 1]> : vector<4xi32>, type = 8 : i32}
