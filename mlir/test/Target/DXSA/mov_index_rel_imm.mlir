// RUN: mlir-translate --import-dxsa-bin %S/inputs/mov_index_rel_imm.bin | FileCheck %s
// mov o0.xyzw, v[r0.x + 66][0].xyzw
...
// CHECK-NEXT:   %4 = dxsa.index.rel.imm %3 {imm = 66 : i32, op = "add"}
