...
; RUN:   FileCheck %s --check-prefixes=CHECK,DYN
; RUN: llc < %s -mtriple arm64e-apple-darwin -aarch64-ptrauth-global-dynamic-mat=1 \
; RUN:     -global-isel -global-isel-abort=1 -verify-machineinstrs |\
; RUN:   FileCheck %s --check-prefixes=CHECK,DYN
; RUN: llc < %s -mtriple arm64e-apple-darwin -aarch64-ptrauth-global-dynamic-mat=0 \
; RUN:     -global-isel -global-isel-abort=1 -verify-machineinstrs |\
; RUN:   FileCheck %s --check-prefixes=CHECK,LOAD
