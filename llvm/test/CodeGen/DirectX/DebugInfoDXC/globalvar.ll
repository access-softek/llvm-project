;; RUN: llc -O0 -mtriple=dxil-pc-shadermodel6.3-library --filetype=obj --dx-embed-debug -o %t.O0.dxbc %s
;; RUN: llvm-objcopy --dump-section=ILDB=%t.O0.bc %t.O0.dxbc
;; RUN: %dxc /dumpbin %t.O0.bc | FileCheck %s --check-prefixes=CHECK,CHECK-O0

;; RUN: llc -mtriple=dxil-pc-shadermodel6.3-library --filetype=obj --dx-embed-debug -o %t.default.dxbc %s
