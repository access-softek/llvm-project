...
; CHECK: DICompositeType: 8
; CHECK: DIDerivedType: 5
; CHECK: DIExpression: 17
; CHECK: DIFile: 1
; CHECK: DIFlagAllCallsDescribed: 7
; CHECK: DIFlagFwdDecl: 1
; CHECK: DIFlagNonTrivial: 1
; CHECK: DIFlagPrototyped: 10
; CHECK: DIFlagTypePassByValue: 3
; CHECK: DIGlobalVariable: 6
; CHECK: DIGlobalVariableExpression: 6
; CHECK: DILexicalBlock: 3
; CHECK: DILocalVariable: 11
; CHECK: DILocation: 44
; CHECK: DISubprogram: 10
; CHECK: DISubrange: 4
