; RUN: llc -mtriple=dxil-pc-shadermodel6.3-library --filetype=obj --dx-embed-debug -O0 -o %t.dxbc %s
...
; CHECK: DIDerivedType: 7
; CHECK: DIExpression: 2
; CHECK: DIFile: 1
; CHECK: DIFlagArtificial: 4
; CHECK: DIFlagObjectPointer: 4
...
!27 = distinct !DISubprogram(name: "B", linkageName: "\01??0B@@QEAA@XZ", scope: !28, file: !1, line: 13, type: !39, isLocal: false, isDefinition: true, scopeLine: 13, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !38, retainedNodes: !42)
...
!51 = distinct !DISubprogram(name: "x2", linkageName: "\01??0x2@@QEAA@H@Z", scope: !15, file: !1, line: 3, type: !20, isLocal: false, isDefinition: true, scopeLine: 3, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !19, retainedNodes: !52)
!52 = !{!53, !54}
