...
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast ptr [[PP:%.*]] to ptr
; CHECK-NEXT:    [[TMP012:%.*]] = load ptr, ptr [[TMP1]], align 8
...
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast ptr [[P:%.*]] to ptr
; CHECK-NEXT:    [[TMP3:%.*]] = call i32 [[TMP1]]() [ "otherbundle"(i64 0) ]
; CHECK-NEXT:    ret i32 [[TMP3]]
;
  %tmp0 = ptrtoint ptr %p to i64
  %tmp1 = call i64 @llvm.ptrauth.sign(i64 %tmp0, i32 2, i64 5678)
  %tmp2 = inttoptr i64 %tmp1 to ptr
  %tmp3 = call i32 %tmp2() [ "ptrauth"(i32 2, i64 5678), "otherbundle"(i64 0) ]
  ret i32 %tmp3
}
...
declare void @foo()
@foo.ptrauth = private constant { ptr, i32, i64, i64 } { ptr bitcast (ptr @foo to ptr), i32 1, i64 0, i64 1234 }, section "llvm.ptrauth", align 8

define i64 @test_ptrauth_nop_global() {
; CHECK-LABEL: @test_ptrauth_nop_global(
; CHECK-NEXT:    ret i64 ptrtoint (ptr @foo to i64)
;
  %authed = call i64 @llvm.ptrauth.auth(i64 ptrtoint(ptr @foo.ptrauth to i64), i32 1, i64 1234)
  ret i64 %authed
}

@foo.ptrauth.1 = private constant { ptr, i32, i64, i64 } { ptr bitcast (ptr @foo to ptr), i32 1, i64 ptrtoint(ptr @foo to i64), i64 1234 }, section "llvm.ptrauth", align 8
