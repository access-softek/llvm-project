...
// expected-error@-1 {{properties may not be qualified with __ptrauth_restricted_intptr; type is '__ptrauth(1,1,1) unsigned long long'}}

@property unsigned long long __ptrauth_restricted_intptr(1, 0, 1) invalid4;
// expected-error@-1 {{properties may not be qualified with __ptrauth_restricted_intptr; type is '__ptrauth(1,0,1) unsigned long long'}}
...
// expected-error@-1 {{return types may not be qualified with __ptrauth_restricted_intptr; type is '__ptrauth(1,1,1) unsigned long long'}}

- (unsigned long long __ptrauth_restricted_intptr(1, 0, 1))invalid8;
// expected-error@-1 {{return types may not be qualified with __ptrauth_restricted_intptr; type is '__ptrauth(1,0,1) unsigned long long'}}
...
// expected-error@-1 {{parameter types may not be qualified with __ptrauth_restricted_intptr; type is '__ptrauth(1,1,1) unsigned long long'}}
// expected-note@-2 {{method 'invalid11:' declared here}}

- (void)invalid12:(unsigned long long __ptrauth_restricted_intptr(1, 0, 1))a;
// expected-error@-1 {{parameter types may not be qualified with __ptrauth_restricted_intptr; type is '__ptrauth(1,0,1) unsigned long long'}}
