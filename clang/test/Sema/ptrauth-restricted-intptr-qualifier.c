...
// expected-error@-1{{parameter types may not be qualified with __ptrauth_restricted_intptr; type is '__ptrauth(0,0,0) unsigned long long'}}

unsigned long long __ptrauth_restricted_intptr(0) y();
// expected-error@-1{{return types may not be qualified with __ptrauth_restricted_intptr; type is '__ptrauth(0,0,0) unsigned long long'}}
#endif