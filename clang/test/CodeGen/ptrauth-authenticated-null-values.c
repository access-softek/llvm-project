...
void f19() {
  ...
  // CHECK: %arrayinit.begin = getelementptr inbounds [5 x ptr], ptr %addr, i64 0, i64 0
  // CHECK: %0 = ptrtoint ptr %arrayinit.begin to i64
  // CHECK: %1 = call i64 @llvm.ptrauth.sign(i64 0, i32 2, i64 %0)
  // CHECK: %2 = inttoptr i64 %1 to ptr
  // CHECK: store ptr %2, ptr %arrayinit.begin
  // CHECK: %arrayinit.start = getelementptr inbounds ptr, ptr %arrayinit.begin, i64 1
  // CHECK: %arrayinit.end = getelementptr inbounds ptr, ptr %arrayinit.begin, i64 5
...
void f23() {
  ...
  // CHECK: arrayinit.begin = getelementptr inbounds [5 x %struct.S1], ptr %addr, i64 0, i64 0
  // CHECK: arrayinit.end = getelementptr inbounds %struct.S1, ptr %arrayinit.begin, i64 5
  // CHECK: br label %arrayinit.body
  // CHECK: arrayinit.cur = phi ptr [ %arrayinit.begin, %entry ], [ %arrayinit.next, %arrayinit.body ]
...
void f24() {
  ...
  // CHECK: %arrayinit.begin = getelementptr inbounds [5 x %struct.S2], ptr %addr, i64 0, i64 0
  // CHECK: %arrayinit.end = getelementptr inbounds %struct.S2, ptr %arrayinit.begin, i64 5
  // CHECK: br label %arrayinit.body
...
void f26() {
  ...
  // CHECK: arrayinit.body:
  // CHECK: %arrayinit.cur = phi ptr [ %arrayinit.begin, %entry ], [ %arrayinit.next, %array_authenticated_null_init.end8 ]
