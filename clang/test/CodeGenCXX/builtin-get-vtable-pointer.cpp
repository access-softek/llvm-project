...
const void *a(A *o) {
  ...
  // CHECK-NOAUTH: %vtable = load ptr, ptr %0, align 8, !tbaa !6
  // CHECK-TYPEAUTH: %0 = load ptr, ptr %o.addr, align 8, !tbaa !2
  // CHECK-TYPEAUTH: %vtable = load ptr, ptr %0, align 8, !tbaa !6
...
const void *c_as_Z(C *o) {
  ...
  // CHECK-NOAUTH: %0 = load ptr, ptr %o.addr, align 8, !tbaa !2
  // CHECK-NOAUTH: %vtable = load ptr, ptr %0, align 8, !tbaa !6
  // CHECK-TYPEAUTH: %vtable = load ptr, ptr %0, align 8, !tbaa !6
  // CHECK-TYPEAUTH: %1 = ptrtoint ptr %vtable to i64
  // CHECK-TYPEAUTH: %2 = call i64 @llvm.ptrauth.auth(i64 %1, i32 2, i64 48388)
...
const void *c_as_B(C *o) {
  ...
  // CHECK-NOAUTH: %vtable = load ptr, ptr %cast.result, align 8, !tbaa !6
  // CHECK-TYPEAUTH: %cast.result = phi ptr [ %add.ptr, %cast.notnull ], [ null, %entry ]
  // CHECK-TYPEAUTH: %vtable = load ptr, ptr %cast.result, align 8, !tbaa !6
...
const void *d_as_A(D *o) {
  ...
  // CHECK-NOAUTH: %cast.result = phi ptr [ %add.ptr, %cast.notnull ], [ null, %entry ]
  // CHECK-NOAUTH: %vtable1 = load ptr, ptr %cast.result, align 8, !tbaa !6
  // CHECK-TYPEAUTH: %vtable1 = load ptr, ptr %cast.result, align 8, !tbaa !6
