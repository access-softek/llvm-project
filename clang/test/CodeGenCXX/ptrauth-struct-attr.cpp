...
// CHECK: define void @_Z17test_conditional0bR2S0S0_(ptr noalias sret(%struct.S0) align 4 %[[AGG_RESULT:.*]], i1 %{{.*}}, ptr nonnull align 4 dereferenceable(24) %{{.*}}, ptr nonnull align 4 dereferenceable(24) %{{.*}})
// CHECK: alloca ptr, align 8
// CHECK: %[[A_ADDR:.*]] = alloca ptr, align 8
// CHECK: %[[B_ADDR:.*]] = alloca ptr, align 8
...
// CHECK: define void @_Z17test_conditional2bR2S2R2S3(ptr noalias sret(%struct.S0) align 4 %[[AGG_RESULT]], i1 %{{.*}}, ptr nonnull align 4 dereferenceable(28) %{{.*}}, ptr nonnull align 4 dereferenceable(32) %{{.*}})
// CHECK: alloca ptr, align 8
// CHECK: %[[A_ADDR:.*]] = alloca ptr, align 8
// CHECK: %[[B_ADDR:.*]] = alloca ptr, align 8
