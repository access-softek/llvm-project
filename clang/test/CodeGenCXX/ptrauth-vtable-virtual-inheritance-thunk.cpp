...
// CHECK: @_ZTV1C.ptrauth = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [5 x ptr], [11 x ptr] }, ptr @_ZTV1C, i32 0, inrange i32 0, i32 3), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTV1C.ptrauth.1 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [5 x ptr], [11 x ptr] }, ptr @_ZTV1C, i32 0, inrange i32 1, i32 6), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
...
// CHECK: @_ZTV1D.ptrauth = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [7 x ptr], [11 x ptr] }, ptr @_ZTV1D, i32 0, inrange i32 0, i32 3), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTV1D.ptrauth.5 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [7 x ptr], [11 x ptr] }, ptr @_ZTV1D, i32 0, inrange i32 1, i32 6), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
...
// CHECK: @_ZTV1F.ptrauth = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [6 x ptr], [7 x ptr], [11 x ptr], [11 x ptr] }, ptr @_ZTV1F, i32 0, inrange i32 0, i32 4), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTC1F0_1C.ptrauth = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [5 x ptr], [11 x ptr] }, ptr @_ZTC1F0_1C, i32 0, inrange i32 0, i32 3), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTC1F0_1C.ptrauth.23 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [5 x ptr], [11 x ptr] }, ptr @_ZTC1F0_1C, i32 0, inrange i32 1, i32 6), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTC1F8_1D.ptrauth = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [7 x ptr], [11 x ptr] }, ptr @_ZTC1F8_1D, i32 0, inrange i32 0, i32 3), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTC1F8_1D.ptrauth.24 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [7 x ptr], [11 x ptr] }, ptr @_ZTC1F8_1D, i32 0, inrange i32 1, i32 6), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTV1F.ptrauth.25 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [6 x ptr], [7 x ptr], [11 x ptr], [11 x ptr] }, ptr @_ZTV1F, i32 0, inrange i32 2, i32 6), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTV1F.ptrauth.26 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [6 x ptr], [7 x ptr], [11 x ptr], [11 x ptr] }, ptr @_ZTV1F, i32 0, inrange i32 1, i32 3), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTV1F.ptrauth.27 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [6 x ptr], [7 x ptr], [11 x ptr], [11 x ptr] }, ptr @_ZTV1F, i32 0, inrange i32 3, i32 6), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
...
// CHECK: @_ZTV1G.ptrauth = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [6 x ptr], [7 x ptr], [11 x ptr], [11 x ptr] }, ptr @_ZTV1G, i32 0, inrange i32 0, i32 4), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTC1G0_1C.ptrauth = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [5 x ptr], [11 x ptr] }, ptr @_ZTC1G0_1C, i32 0, inrange i32 0, i32 3), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTC1G0_1C.ptrauth.68 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [5 x ptr], [11 x ptr] }, ptr @_ZTC1G0_1C, i32 0, inrange i32 1, i32 6), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTC1G8_1D.ptrauth = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [7 x ptr], [11 x ptr] }, ptr @_ZTC1G8_1D, i32 0, inrange i32 0, i32 3), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTC1G8_1D.ptrauth.69 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [7 x ptr], [11 x ptr] }, ptr @_ZTC1G8_1D, i32 0, inrange i32 1, i32 6), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTV1G.ptrauth.70 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [6 x ptr], [7 x ptr], [11 x ptr], [11 x ptr] }, ptr @_ZTV1G, i32 0, inrange i32 2, i32 6), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTV1G.ptrauth.71 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [6 x ptr], [7 x ptr], [11 x ptr], [11 x ptr] }, ptr @_ZTV1G, i32 0, inrange i32 3, i32 6), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
// CHECK: @_ZTV1G.ptrauth.72 = private constant { ptr, i32, i64, i64 } { ptr getelementptr inbounds ({ [6 x ptr], [7 x ptr], [11 x ptr], [11 x ptr] }, ptr @_ZTV1G, i32 0, inrange i32 1, i32 3), i32 2, i64 0, i64 0 }, section "llvm.ptrauth", align 8
