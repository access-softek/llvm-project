...
// CHECK: define void @test_call4(ptr noalias sret(%struct.S4) align 16 %[[AGG_RESULT:.*]], ptr %[[A:.*]])
...
// CHECK: %[[V12:.*]] = inttoptr i64 %[[V11]] to ptr
// CHECK: call void @func2(ptr sret(%struct.S4) align 16 %[[V9]], ptr %[[V12]])
...
// CHECK: %[[ATOMIC_LOAD:.*]] = load atomic i64, ptr %[[P]] seq_cst, align 8
// CHECK: %[[V2:.*]] = inttoptr i64 %[[ATOMIC_LOAD]] to ptr

// CHECK: %[[V3:.*]] = phi ptr [ %[[V2]], %{{.*}} ], [ %[[V16:.*]], %{{.*}} ]
// CHECK: %[[V4:.*]] = ptrtoint ptr %[[V3]] to i64
// CHECK: %[[V5:.*]] = call i64 @llvm.ptrauth.auth(i64 %[[V4]], i32 1, i64 100)
// CHECK: %[[V6:.*]] = inttoptr i64 %[[V5]] to ptr
// CHECK: %[[INCDEC_PTR:.*]] = getelementptr inbounds %[[STRUCT_S0]], ptr %[[V6]], i32 1
// CHECK: %[[V7:.*]] = ptrtoint ptr %[[INCDEC_PTR]] to i64
// CHECK: %[[V8:.*]] = call i64 @llvm.ptrauth.sign(i64 %[[V7]], i32 1, i64 100)
// CHECK: %[[V9:.*]] = inttoptr i64 %[[V8]] to ptr
// CHECK: %[[V10:.*]] = ptrtoint ptr %[[V3]] to i64
// CHECK: %[[V11:.*]] = ptrtoint ptr %[[V9]] to i64
// CHECK: %[[V13:.*]] = cmpxchg ptr %[[P]], i64 %[[V10]], i64 %[[V11]] seq_cst seq_cst
// CHECK: %[[V14:.*]] = extractvalue { i64, i1 } %[[V13]], 0
// CHECK: %[[V16]] = inttoptr i64 %[[V14]] to ptr
