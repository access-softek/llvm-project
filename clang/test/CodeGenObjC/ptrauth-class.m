// RUN: %clang_cc1 -Wno-everything -fblocks -fptrauth-intrinsics -triple arm64-apple-ios -target-feature +pauth -fobjc-runtime=ios-12.2 -emit-llvm -no-enable-noundef-analysis -fobjc-arc -O2 -disable-llvm-passes -o - %s | FileCheck %s
...
void setTestStructIsa(struct TestStruct *t, Class c) {
  ...
  // CHECK: [[ISA_SLOT:%.*]] = getelementptr inbounds %struct.TestStruct, ptr %0, i32 0, i32 0
...
Class getTestStructIsa(struct TestStruct *t) {
  ...
  // CHECK: [[ISA_SLOT:%.*]] = getelementptr inbounds %struct.TestStruct, ptr [[T_VALUE]], i32 0, i32 0
