...
#include "libcall-set-defaults.inc"

#define DECLARE_LIBCALL(rettype, libcall_name, ...) \
...
DECLARE_LIBCALL(int, __paritysi2, si_int a);
DECLARE_LIBCALL(int, __paritydi2, di_int a);

DECLARE_LIBCALL(di_int, __divdi3, di_int a, di_int b);
DECLARE_LIBCALL(si_int, __divsi3, si_int a, si_int b);
DECLARE_LIBCALL(su_int, __udivsi3, su_int n, su_int d);

DECLARE_LIBCALL(su_int, __udivmodsi4, su_int a, su_int b, su_int *rem);
DECLARE_LIBCALL(du_int, __udivmoddi4, du_int a, du_int b, du_int *rem);
#ifdef CRT_HAS_128BIT
DECLARE_LIBCALL(int, __clzti2, ti_int a);
