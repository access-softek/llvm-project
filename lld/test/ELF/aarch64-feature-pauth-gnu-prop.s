...
# OK: Properties: AArch64 PAuth ABI tag: platform 0x2a (unknown), version 0x1
...
# ERR4:      error: {{.*}}noinfo1.o: -z pauth-report: file does not have AArch64 PAuth compatibility info while {{.*}}tag11.o has one
# ERR4-NEXT: error: {{.*}}noinfo2.o: -z pauth-report: file does not have AArch64 PAuth compatibility info while {{.*}}tag11.o has one
# WARN:      warning: {{.*}}noinfo1.o: -z pauth-report: file does not have AArch64 PAuth compatibility info while {{.*}}tag11.o has one
# WARN-NEXT: warning: {{.*}}noinfo2.o: -z pauth-report: file does not have AArch64 PAuth compatibility info while {{.*}}tag11.o has one
